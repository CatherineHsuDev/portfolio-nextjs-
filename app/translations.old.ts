...
//       // Intro
//       intro:
//         "I am Catherine, a bilingual self-taught full-stack developer who builds modern, practical, and human-centered web applications. I specialize in React, Next.js, TypeScript, Node.js. I enjoy turning ideas into clean, structured, and useful products.",

//       // Section: My Path into Engineering
//       pathHeading: "My Path into Engineering",
//       pathParagraph1:
//         "My journey into software was not traditional. I learned everything independently from studying documentation, analyzing real websites, breaking down UI patterns, and building projects from scratch. Over the years, I taught myself how to think like an engineer by repeatedly solving real problems.",
...
//       howParagraph1:
//         "I approach development with a designer’s mindset including clarity, spacing, consistency, and patterns matter. I like building systems that feel clean, intentional, and easy to maintain.",
//       howParagraph2:
...
//       buildIntro: "I build tools that are practical and impactful:",
//       buildItems: [
...
//       // Intro
//       intro:
//         "我是 Catherine，一位雙語自學全端開發者，專注打造現代、實用且以使用者為中心的網頁應用。我擅長 React、Next.js、TypeScript 與 Node.js，喜歡把想法轉化為乾淨、有結構、真正有用的產品。",

//       // Section: My Path into Engineering
//       pathHeading: "我如何走進工程領域",
//       pathParagraph1:
//         "我的軟體開發之路並不傳統。我完全靠自學成長——閱讀官方文件、拆解真實網站、分析 UI pattern，並從零開始完成專案。透過一次次解決實際問題，我學會用工程師的方式思考。",
...
//       howHeading: "我如何工作",
//       howParagraph1:
//         "我用設計師的思維在寫程式——版面留白、層級關係、一致性與可重複的 pattern 都很重要。我喜歡建立結構清晰、容易維護、能長期演進的系統。",
//       howParagraph2:
//         "我非常在意使用者體驗。好的產品工程應該讓使用者感到好用、流程順暢、對!我就是要這個功能，而不是製造障礙，使用起來不流暢。如果一個專案能讓某人的生活或工作變得更順，我就會很想把它做好。",

//       // Section: What I Build
//       buildHeading: "我擅長打造的東西",
...
//       portfolioIntro:
//         "這個作品集紀錄了我的學習歷程，包含我完成的專案、解決過的挑戰，以及逐漸形成的工程思維。它是一個當下的紀錄，呈現我如何思考、如何學習，也如何透過實作、試錯不斷成長。",
